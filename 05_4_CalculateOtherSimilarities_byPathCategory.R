...
# myrun<-paste("Rscript 05_4_CalculateOtherSimilarities_byPathCategory.R 2",
...
#### Which is the amount of interactions that we would expect randomly selecting genes from the same size? ####



## Which is the correlation threshold for each pathway that will give us significant correlations not detected randomly? ##
