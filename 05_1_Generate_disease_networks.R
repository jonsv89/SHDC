...
build_network<-function(nameout,classification,experiment){
  if("Generated_Networks"%in%list.files(experiment)==FALSE){dir.create(paste(experiment,"/Generated_Networks",sep=""))}
  ## Start the analysis!! ##
  ## @@ @@ @@ @@ @@ @@ @@ ##
  ...
  fishtab2<-fishtab
  ## Correct Fisher's Exact test p-values for multiple testing (number of disease comparisons * 4 sDEGs comparisons (up-up, down-down, up-down, down-up))
  ...
  ## Write the tables ##
  write.table(netall,paste(experiment,"/Generated_Networks/",classification,"_",nameout,"_pvals_network.txt",sep=""),quote=F,sep="\t",row.names=F)
...
print("Networks generated when adjusting for sex")
...
print("Networks generated separately for men and women")
...
print("Networks generated comparing men and women in cases and controls")
