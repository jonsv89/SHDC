...
## This code is used to calculate other metrics (cosine similarities and euclidean, manhattan, and canberra distances) ##
## calculating also the p-values of the metrics (thanks to Mare Nostrum 4) ##
...
# myrun<-c(paste("Rscript 05_2_Generate_disease_networks_OtherMetrics.R 2",
...
#          paste("Rscript 05_2_Generate_disease_networks_OtherMetrics.R 4",
#                c(paste("Adjusted","ICD9","Microarrays"),paste("Adjusted","ICD10","Microarrays"),
#                  paste("Women","ICD9","Microarrays"),paste("Men","ICD9","Microarrays"),paste("Women","ICD10","Microarrays"),paste("Men","ICD10","Microarrays"),
#                  paste("Cases","ICD9","Microarrays"),paste("Controls","ICD9","Microarrays"),paste("Cases","ICD10","Microarrays"),paste("Controls","ICD10","Microarrays"))),
#          paste("Rscript 05_2_Generate_disease_networks_OtherMetrics.R 5",
#                c(paste("Adjusted","ICD9","Microarrays"),paste("Adjusted","ICD10","Microarrays"),
#                  paste("Women","ICD9","Microarrays"),paste("Men","ICD9","Microarrays"),paste("Women","ICD10","Microarrays"),paste("Men","ICD10","Microarrays"),
#                  paste("Cases","ICD9","Microarrays"),paste("Controls","ICD9","Microarrays"),paste("Cases","ICD10","Microarrays"),paste("Controls","ICD10","Microarrays"))),
#          paste("Rscript 05_2_Generate_disease_networks_OtherMetrics.R 6",
#                c(paste("Adjusted","ICD9","Microarrays"),paste("Adjusted","ICD10","Microarrays"),
#                  paste("Women","ICD9","Microarrays"),paste("Men","ICD9","Microarrays"),paste("Women","ICD10","Microarrays"),paste("Men","ICD10","Microarrays"),
#                  paste("Cases","ICD9","Microarrays"),paste("Controls","ICD9","Microarrays"),paste("Cases","ICD10","Microarrays"),paste("Controls","ICD10","Microarrays"))))
